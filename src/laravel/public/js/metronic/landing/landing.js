...
/***/ "./resources/component/metronic/theme/demo1/dist/assets/js/scripts.bundle.js":
/*!***********************************************************************************!*\
  !*** ./resources/component/metronic/theme/demo1/dist/assets/js/scripts.bundle.js ***!
  \***********************************************************************************/
/***/ ((module) => {
...
var KTDialer = function KTDialer(e, t) {
  var n = this;
...
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTDialer.init) : KTDialer.init(),  true && void 0 !== module.exports && (module.exports = KTDialer);

var KTDrawer = function KTDrawer(e, t) {
  var n = this,
  ...
  if (null != e) {
    var r = {
      ...
      overlayClass: "drawer-overlay"
        ...
        o = function o() {
      n.options = KTUtil.deepExtend({}, r, t), n.uid = KTUtil.getUniqueId("drawer"), n.element = e, n.overlayElement = null, n.name = n.element.getAttribute("data-kt-drawer-name"), n.shown = !1, n.lastWidth, n.toggleElement = null, a(), d(), KTUtil.data(n.element).set("drawer", n);
    },
        a = function a() {
      var e = f("toggle"),
          t = f("close");
...
KTDrawer.getInstance = function (e) {
  ...
  KTDrawer.createInstances('[data-kt-drawer="true"]'), KTDrawer.handleToggle();
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTDrawer.init) : KTDrawer.init(),  true && void 0 !== module.exports && (module.exports = KTDrawer);

var KTEventHandler = function () {
  var e = {},
      t = function t(_t, n, i, r) {
    var o = KTUtil.getUniqueId("event");
    KTUtil.data(_t).set(n, o), e[n] || (e[n] = {}), e[n][o] = {
      name: n,
      callback: i,
      one: r,
      fired: !1
 ...
 true && void 0 !== module.exports && (module.exports = KTEventHandler);

var KTFeedback = function KTFeedback(e) {
  var t = this,
 ...
 true && void 0 !== module.exports && (module.exports = KTFeedback);
...
var KTMenu = function KTMenu(e, t) {
  var n = this;
  ...
  if (null != e) {
    var i = {
      ...
      accordion: {
        ...
        r = function r() {
      n.options = KTUtil.deepExtend({}, i, t), n.uid = KTUtil.getUniqueId("menu"), n.element = e, n.triggerElement, d(), u(), KTUtil.data(n.element).set("menu", n);
    },
        o = function o(e) {
      null !== e && (!0 === m(e) ? l(e) : a(e));
    },
        a = function a(e) {
      null !== e && !0 !== m(e) && ("dropdown" === v(e) ? E(e) : "accordion" === v(e) && S(e), KTUtil.data(e).set("type", v(e)));
    },
        l = function l(e) {
      null !== e && !1 !== m(e) && ("dropdown" === v(e) ? w(e) : "accordion" === v(e) && A(e));
    },
        s = function s(e) {
      if (!1 !== f(e)) {
        var t = p(e);
      ...
      if (e && e.length > 0) for (var t = 0, i = e.length; t < i; t++) {
        s(e[t]);
      }
    },
        d = function d() {
      ...
      if (i && i.length > 0) for (var r = 0, o = i.length; r < o; r++) {
        t = i[r], "accordion" === v(t) && t !== e && !1 === e.contains(t) && !1 === t.contains(e) && A(t);
      }
    },
        x = function x(e, t) {
      var n,
    ...
    !0 === KTUtil.data(e).has("menu") ? n = KTUtil.data(e).get("menu") : r(), n.click = function (e, t) {
      ...
      return function (e, t) {
        var n = T(e),
            i = U(n);
        if (null !== n && "dropdown" === v(n) && (l(n), i.length > 0)) for (var r = 0, o = i.length; r < o; r++) {
      ...
      return function (e) {
        return n.triggerElement ? n.triggerElement : g(e);
      }(e);
...
KTMenu.getInstance = function (e) {
  ...
  document.addEventListener("click", function (e) {
    ...
    if (r && r.length > 0) for (var o = 0, a = r.length; o < a; o++) {
...
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTMenu.init) : KTMenu.init(),  true && void 0 !== module.exports && (module.exports = KTMenu);

var KTPasswordMeter = function KTPasswordMeter(e, t) {
  var n = this;
...
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTPasswordMeter.init) : KTPasswordMeter.init(),  true && void 0 !== module.exports && (module.exports = KTPasswordMeter);

var KTPlace = function KTPlace(e, t) {
  var n = this;
  ...
  if (null != e) {
    var i = {
      mode: "append"
        ...
        r = function r() {
      n.element = e, n.options = KTUtil.deepExtend({}, i, t), o(), KTUtil.data(n.element).set("place", n);
    },
        o = function o(t) {
      var n = a("parent"),
          i = a("mode"),
    ...
    !0 === KTUtil.data(e).has("place") ? n = KTUtil.data(e).get("place") : r(), n.update = function () {
      o();
    }, n.on = function (e, t) {
      return KTEventHandler.on(n.element, e, t);
    }, n.one = function (e, t) {
...
KTPlace.getInstance = function (e) {
  ...
  KTUtil.throttle(undefined, function () {
    ...
    if (e && e.length > 0) for (var t = 0, n = e.length; t < n; t++) {
      KTPlace.getInstance(e[t]).update();
    }
  }, 200);
}), KTPlace.init = function () {
  KTPlace.createInstances('[data-kt-place="true"]');
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTPlace.init) : KTPlace.init(),  true && void 0 !== module.exports && (module.exports = KTPlace);

var KTScroll = function KTScroll(e, t) {
  var n = this;
  ...
  if (e) {
    var i = {
      saveState: !0
        ...
        r = function r() {
      n.options = KTUtil.deepExtend({}, i, t), n.element = e, n.id = n.element.getAttribute("id"), a(), KTUtil.data(n.element).set("scroll", n);
    },
        o = function o() {
...
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTScroll.init) : KTScroll.init(),  true && void 0 !== module.exports && (module.exports = KTScroll);

var KTScrolltop = function KTScrolltop(e, t) {
  var n = this,
      i = document.getElementsByTagName("BODY")[0];
  ...
  if (null != e) {
    var r = {
      ...
      speed: 600
        ...
        o = function o() {
      n.options = KTUtil.deepExtend({}, r, t), n.uid = KTUtil.getUniqueId("scrolltop"), n.element = e, a(), KTUtil.data(n.element).set("scrolltop", n);
    },
        a = function a() {
...
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTScrolltop.init) : KTScrolltop.init(),  true && void 0 !== module.exports && (module.exports = KTScrolltop);

var KTSearch = function KTSearch(e, t) {
  var n = this;
  ...
  if (e) {
    var i = {
      ...
      n.options = KTUtil.deepExtend({}, i, t), n.processing = !1, n.element = e, n.contentElement = v("content"), n.formElement = v("form"), n.inputElement = v("input"), n.spinnerElement = v("spinner"), n.clearElement = v("clear"), n.toggleElement = v("toggle"), n.submitElement = v("submit"), n.toolbarElement = v("toolbar"), n.resultsElement = v("results"), n.suggestionElement = v("suggestion"), n.emptyElement = v("empty"), n.layout = p("layout"), "menu" === n.layout ? n.menuObject = new KTMenu(n.contentElement) : n.menuObject = null, m(), o(), KTUtil.data(n.element).set("search", n);
        ...
        o = function o() {
      n.inputElement.addEventListener("focus", a), n.inputElement.addEventListener("blur", l), !0 === p("keypress") && n.inputElement.addEventListener("input", u), n.submitElement && n.submitElement.addEventListener("click", d), !0 === p("enter") && n.inputElement.addEventListener("keypress", s), n.clearElement && n.clearElement.addEventListener("click", c), n.menuObject && (n.toggleElement && (n.toggleElement.addEventListener("click", f), n.menuObject.on("kt.menu.dropdown.show", function (e) {
        ...
        a = function a() {
      n.element.classList.add("focus"), (!0 === p("show-on-focus") || n.inputElement.value.length >= minLength) && f();
    },
        l = function l() {
      ...
      !1 === n.processing && (n.spinnerElement && n.spinnerElement.classList.remove("d-none"), n.clearElement && n.clearElement.classList.add("d-none"), n.toolbarElement && n.toolbarElement.classList.add("d-none"), n.inputElement.focus(), n.processing = !0, KTEventHandler.trigger(n.element, "kt.search.process", n));
        ...
        c = function c() {
      !1 !== KTEventHandler.trigger(n.element, "kt.search.clear", n) && (n.inputElement.value = "", n.inputElement.focus(), n.clearElement && n.clearElement.classList.add("d-none"), n.toolbarElement && n.toolbarElement.classList.remove("d-none"), !1 === p("show-on-focus") && g(), KTEventHandler.trigger(n.element, "kt.search.cleared", n));
    },
        m = function m() {
      if ("menu" === n.layout) {
        var e = T();
...
},  true && void 0 !== module.exports && (module.exports = KTSearch);

var KTStepper = function KTStepper(e, t) {
  var n = this;
  document.getElementsByTagName("BODY")[0];
  ...
  if (null != e) {
    var i = {
      ...
      n.options = KTUtil.deepExtend({}, i, t), n.uid = KTUtil.getUniqueId("stepper"), n.element = e, n.steps = KTUtil.findAll(n.element, '[data-kt-stepper-element="nav"]'), n.btnNext = KTUtil.find(n.element, '[data-kt-stepper-action="next"]'), n.btnPrevious = KTUtil.find(n.element, '[data-kt-stepper-action="previous"]'), n.btnSubmit = KTUtil.find(n.element, '[data-kt-stepper-action="submit"]'), n.totalStepsNumber = n.steps.length, n.passedStepIndex = 0, n.currentStepIndex = 1, n.options.startIndex > 1 && o(n.options.startIndex), KTUtil.addEvent(n.btnNext, "click", function (e) {
        ...
        if (e.PreviousentDefault(), n.steps && n.steps.length > 0) for (var t = 0, i = n.steps.length; t < i; t++) {
...
},  true && void 0 !== module.exports && (module.exports = KTStepper);

var KTSticky = function KTSticky(e, t) {
  var n = this,
      i = document.getElementsByTagName("BODY")[0];
  ...
  if (null != e) {
    var r = {
      ...
      animationClass: "animation-slide-in-down"
        ...
        o = function o() {
      n.element = e, n.options = KTUtil.deepExtend({}, r, t), n.uid = KTUtil.getUniqueId("sticky"), n.name = n.element.getAttribute("data-kt-sticky-name"), n.attributeName = "data-kt-sticky-" + n.name, n.eventTriggerState = !0, n.lastScrollTop = 0, window.addEventListener("scroll", a), a(), KTUtil.data(n.element).set("sticky", n);
    },
        a = function a(e) {
      var t,
          r = u("offset"),
...
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTSticky.init) : KTSticky.init(),  true && void 0 !== module.exports && (module.exports = KTSticky);

var KTToggle = function KTToggle(e, t) {
  var n = this;
  document.getElementsByTagName("BODY")[0];
...
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTToggle.init) : KTToggle.init(),  true && void 0 !== module.exports && (module.exports = KTToggle), Element.prototype.matches || (Element.prototype.matches = function (e) {
...
var KTUtil = function () {
  ...
  return {
    ...
    removeResizeHandler: function removeResizeHandler(t) {
    ...
    isBreakpointUp: function isBreakpointUp(e) {
      return this.getViewPort().width >= this.getBreakpoint(e);
    },
    isBreakpointDown: function isBreakpointDown(e) {
      return this.getViewPort().width < this.getBreakpoint(e);
    },
    ...
    deepExtend: function deepExtend(e) {
      e = e || {};
    ...
    addClass: function addClass(e, t) {
      if (e && void 0 !== t) {
        var n = t.split(" ");
        if (e.classList) for (var i = 0; i < n.length; i++) {
          n[i] && n[i].length > 0 && e.classList.add(KTUtil.trim(n[i]));
        } else if (!KTUtil.hasClass(e, t)) for (var r = 0; r < n.length; r++) {
    ...
    triggerCustomEvent: function triggerCustomEvent(e, t, n) {
      var i;
    ...
    outerWidth: function outerWidth(e, t) {
      var n;
    ...
    outerHeight: function outerHeight(e, t) {
      var n,
          i = e.offsetHeight;
    ...
    actualCss: function actualCss(e, t, n) {
      var i,
          r = "";
    ...
    actualHeight: function actualHeight(e, t) {
      return KTUtil.actualCss(e, "height", t);
    },
    actualWidth: function actualWidth(e, t) {
      return KTUtil.actualCss(e, "width", t);
    },
    getScroll: function getScroll(e, t) {
    ...
    slide: function slide(e, t, n, i, r) {
    ...
    slideUp: function slideUp(e, t, n) {
      KTUtil.slide(e, "up", t, n);
    },
    slideDown: function slideDown(e, t, n) {
    ...
    addEvent: function addEvent(e, t, n, i) {
    ...
    animateClass: function animateClass(e, t, n) {
      var i,
          r = {
    ...
    animationEnd: function animationEnd(e, t) {
      var n,
          i = {
        animation: "animationend",
        OAnimation: "oAnimationEnd",
    ...
    animateDelay: function animateDelay(e, t) {
      for (var n = ["webkit-", "moz-", "ms-", "o-", ""], i = 0; i < n.length; i++) {
        KTUtil.css(e, n[i] + "animation-delay", t);
      }
    },
    animateDuration: function animateDuration(e, t) {
      for (var n = ["webkit-", "moz-", "ms-", "o-", ""], i = 0; i < n.length; i++) {
    ...
    scrollTop: function scrollTop(e, t) {
    ...
    snakeToCamel: function snakeToCamel(e) {
      return e.replace(/(\-\w)/g, function (e) {
        return e[1].toUpperCase();
      });
    },
    filterBoolean: function filterBoolean(e) {
    ...
    colorLighten: function colorLighten(e, t) {
      var n = function n(e, t) {
        var n = parseInt(e, 16) + t,
            i = n > 255 ? 255 : n;
        return i = i.toString(16).length > 1 ? i.toString(16) : "0".concat(i.toString(16)), i;
      };

      return e = e.indexOf("#") >= 0 ? e.substring(1, e.length) : e, t = parseInt(255 * t / 100), "#".concat(n(e.substring(0, 2), t)).concat(n(e.substring(2, 4), t)).concat(n(e.substring(4, 6), t));
    },
    colorDarken: function colorDarken(e, t) {
      var n = function n(e, t) {
        var n = parseInt(e, 16) - t,
            i = n < 0 ? 0 : n;
        return i = i.toString(16).length > 1 ? i.toString(16) : "0".concat(i.toString(16)), i;
    ...
    getResponsiveValue: function getResponsiveValue(e, t) {
      var n,
          i = this.getViewPort().width;

      if ("object" == _typeof(e = KTUtil.parseJson(e))) {
        var r,
            o,
            a = -1;

        for (var l in e) {
          (o = "default" === l ? 0 : this.getBreakpoint(l) ? this.getBreakpoint(l) : parseInt(l)) <= i && o > a && (r = l, a = o);
        }
    ...
    getSelectorMatchValue: function getSelectorMatchValue(e) {
      var t = null;
    ...
    getConditionalValue: function getConditionalValue(e) {
 ...
 true && void 0 !== module.exports && (module.exports = KTUtil);

var KTApp = function () {
  var e = function e(_e, t) {
    var n = {};
    return _e.hasAttribute("data-bs-delay-hide") && (n.hide = _e.getAttribute("data-bs-delay-hide")), _e.hasAttribute("data-bs-delay-show") && (n.show = _e.getAttribute("data-bs-delay-show")), n && (t.delay = n), new bootstrap.Tooltip(_e, t);
  },
      t = function t(e, _t2) {
    var n = {};
    e.hasAttribute("data-bs-delay-hide") && (n.hide = e.getAttribute("data-bs-delay-hide")), e.hasAttribute("data-bs-delay-show") && (n.show = e.getAttribute("data-bs-delay-show")), n && (_t2.delay = n), "true" == e.getAttribute("data-bs-dismiss") && (_t2.dismiss = !0), !0 === _t2.dismiss && (_t2.template = '<div class="popover" role="tooltip"><div class="popover-arrow"></div><span class="popover-dismiss btn btn-icon"><i class="bi bi-x fs-2"></i></span><h3 class="popover-header"></h3><div class="popover-body"></div></div>');
    var i = new bootstrap.Popover(e, _t2);
    ...
    [].slice.call(document.querySelectorAll('[data-kt-countup="true"]:not(.counted)')).map(function (e) {
      ...
      i = function i() {
    var e = Array.prototype.slice.call(document.querySelectorAll('[data-tns="true"]'), 0);
      ...
      !function (e) {
        ...
        e.getAttributeNames().forEach(function (n) {
          if (/^data-tns-.*/g.test(n)) {
            var r = n.replace("data-tns-", "").toLowerCase().replace(/(?:[\s-])\w/g, function (e) {
              return e.replace("-", "").toUpperCase();
            });

            if ("data-tns-responsive" === n) {
              var _i = e.getAttribute(n).replace(/(\w+:)|(\w+ :)/g, function (e) {
                return '"' + e.substring(0, e.length - 1) + '":';
              });
  ...
  return {
    ...
    initBootstrapTooltip: function initBootstrapTooltip(t, n) {
      return e(t, n);
    },
    ...
    initBootstrapPopover: function initBootstrapPopover(e, n) {
      return t(e, n);
    },
    initScrollSpy: function initScrollSpy() {
      [].slice.call(document.querySelectorAll('[data-bs-spy="scroll"]')).map(function (e) {
        ...
        var t = e.hasAttribute("data-bs-target-offset") ? parseInt(e.getAttribute("data-bs-target-offset")) : 0;
        KTUtil.on(document.body, e.getAttribute("data-bs-target") + " [href]", "click", function (e) {
          e.preventDefault();
          var n = document.querySelector(this.getAttribute("href"));
          KTUtil.scrollTo(n, t);
        });
        var n = document.querySelector(e.getAttribute("data-bs-target")),
            i = bootstrap.ScrollSpy.getInstance(n);
        i && i.refresh();
      });
    },
    ...
    initSmoothScroll: function initSmoothScroll() {
      SmoothScroll && new SmoothScroll('a[data-kt-scroll-toggle][href*="#"]', {
        offset: function offset(e, t) {
          return e.hasAttribute("data-kt-scroll-offset") ? e.getAttribute("data-kt-scroll-offset") : 0;
        }
      });
    }
  };
...
}),  true && void 0 !== module.exports && (module.exports = KTApp);
...
(() => {
/*!********************************************************!*\
  !*** ./resources/component/include/landing/landing.js ***!
  \********************************************************/
/*require('../../metronic/theme/demo1/dist/assets/plugins/global/plugins.bundle');*/
__webpack_require__(/*! ../../metronic/theme/demo1/dist/assets/js/scripts.bundle */ "./resources/component/metronic/theme/demo1/dist/assets/js/scripts.bundle.js");
/*require('../../metronic/theme/demo1/dist/assets/plugins/custom/fslightbox/fslightbox.bundle');
require('../../metronic/theme/demo1/dist/assets/plugins/custom/typedjs/typedjs.bundle');
require('../../metronic/theme/demo1/dist/assets/js/custom/landing');
require('../../metronic/theme/demo1/dist/assets/js/custom/pages/company/pricing');

require ('../../metronic/theme/demo1/dist/assets/js/custom/widgets') ;
require ('../../metronic/theme/demo1/dist/assets/js/custom/apps/chat/chat') ;
require ('../../metronic/theme/demo1/dist/assets/js/custom/modals/create-app') ;
require ('../../metronic/theme/demo1/dist/assets/js/custom/modals/upgrade-plan') ;
require ('../../metronic/theme/demo1/dist/assets/js/custom/intro') ;*/
