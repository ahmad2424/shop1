            ...
            <div class="col">
                ...
                <form action="{{route('login' )}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input id="password" class="form-control" type="password" name="password" required value="{{ old('password') }}">
                    </div>
            ...
            <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_sign_in_form" action="{{route('login' )}}" method="post">
                ...
                <div class="fv-row mb-10 fv-plugins-icon-container">
                    ...
                    <div class="d-flex flex-stack mb-2">
                        ...
                        <!--end::Label-->
                        <!--begin::Link-->
                        <a href="{{route('forget_password')}}" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
                        <!--end::Link-->
                    </div>
                    <!--end::Wrapper-->
                    <!--begin::Input-->
                ...
                <div class="text-center">
                    ...
                    <!--end::Separator-->
                    <!--begin::Google link-->
                    <a href="{{route('auth.google' , 'google' )}}" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
                        <img alt="Logo" src="{{asset('resources/google.svg')}}" class="h-20px me-3">Continue with Google</a>
                    <!--end::Google link-->
                    <!--begin::Google link-->
                    <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
                        <img alt="Logo" src="{{asset('resources/facebook.svg')}}" class="h-20px me-3">Continue with Facebook</a>
                    <!--end::Google link-->
                    <!--begin::Google link-->
                    <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100">
                        <img alt="Logo" src="{{asset('resources/github.svg')}}" class="h-20px me-3">Continue with Apple</a>
                    <!--end::Google link-->
                </div>
                <!--end::Actions-->
                <div></div></form>
